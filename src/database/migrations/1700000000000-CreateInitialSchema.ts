  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          { name: 'id', type: 'uuid', isPrimary: true, generationStrategy: 'uuid'},
          { name: 'name', type: 'varchar', length: '50', isNullable: false },
          { name: 'code', type: 'varchar', length: '30', isNullable: false },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          { name: 'id', type: 'uuid', isPrimary: true, generationStrategy: 'uuid'},
          { name: 'email', type: 'varchar', length: '50', isUnique: true, isNullable: false },
          { name: 'password', type: 'varchar', length: '100', isNullable: false },
          { name: 'first_name', type: 'varchar', length: '50', isNullable: false },
          { name: 'last_name', type: 'varchar', length: '', isNullable: false },
          { name: 'phone', type: 'varchar', length: '15', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'pin_hash', type: 'varchar', length: '100', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'merchant', type: 'varchar', length: '50', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          { name: 'id', type: 'uuid', isPrimary: true, generationStrategy: 'uuid'},
          { name: 'name', type: 'varchar', length: '50', isNullable: false },
          { name: 'code', type: 'varchar', length: '30', isUnique: true, isNullable: false },
          { name: 'description', type: 'text', isNullable: true },
          { name: 'establishment_id', type: 'uuid', isNullable: false },
